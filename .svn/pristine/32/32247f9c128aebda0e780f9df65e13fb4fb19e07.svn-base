...
<html lang="vi-vn">
<head>
<link rel="shortcut icon" type="image/png" href="<?php echo get_template_directory_uri()?>
/viettel.png"> <title><?php
            if (is_single()) {
                echo get_the_title();
            } elseif(is_category()){
                echo "Chuyên mục: ".get_the_category()[0]->
name; } elseif(is_page()){ echo get_the_title(); } ?></title>
<meta charset="UTF-8">
...
<link rel="stylesheet" id="mh-magazine-lite-css" href="<?php echo get_template_directory_uri() ?>
/image2/style.css" type="text/css" media="all">
<link rel="stylesheet" id="mh-newsmagazine-css" href="<?php echo get_template_directory_uri() ?>
/image2/style(1).css" type="text/css" media="all">
<link rel="stylesheet" id="mh-font-awesome-css" href="<?php echo get_template_directory_uri() ?>
/image2/font-awesome.min.css" type="text/css" media="all">

    <?php
    wp_head();
    ?>
<meta property="og:title" content="<?php if (is_single()) { echo get_the_title(); } elseif(is_category()){ echo " chuyên mục: ".get_the_category()[0]->
name; } elseif(is_page()){ echo get_the_title(); } ?>" />
...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery_3_3_1.min.js"></script>
...
<link rel="alternate" href="<?php echo get_home_url() ?>
" hreflang="vn-vi">
...
<style type="text/css">
    ...
    <?php echo (is_page(2017))? ".xanhduong {background: #00918D; }":"" ?>
    .muahang-btn{
...
<?php include('facebook-script.php'); ?>
<?php wp_head(); ?>
</head>
...
<div class="wrap">
    ...
    <div class="top-bar">
        <div class="container text-right">
            ...
            <div class="carrers-icon pull-left">
                <a id="hover-viettel" class="icon" href="<?php echo home_url(); ?>"> 
                    <img src="<?php echo get_template_directory_uri(); ?>/images/vina.png">
                </a>
                <a id="hover-viettel" class="icon" href="<?php echo home_url(); ?>/mobifone"> 
                    <img src="<?php echo get_template_directory_uri(); ?>/images/mobi.png">
                </a>
            </div>
            <div class="clearfix hidden-xs">
            </div>
            <div class="hidden-sm logo-mobile hidden-lg hidden-md text-center col-xs-6">
                <a href="<?php echo home_url();?>/viettel"></a>
            </div>
    ...
    <div class="navigate" id="navigate">
        <div class="over hidden-xs">
        </div>
        <div class="container">
            <a href="<?php echo home_url(); ?>/viettel" class="logo hidden-xs"> <img src="<?php echo get_template_directory_uri();?>/assets/images/logo_viettel.png"/> </a>
            <ul class="menu-nav">
                <?php  
                                //include('menu-top-'.$page_name.'.php');
                            ?>
                <?php wp_nav_menu( array( 'theme_location' =>
                 'viettel-menu','menu_class' => 'menu') ); ?>
            </ul>
        </div>
    </div>
    </section>