...
/vinaphone.ico"> <title><?php
        if (is_single()) {
            echo get_the_title();
        } elseif(is_category()){
            echo "Chuyên mục: ".get_the_category()[0]->
name; } elseif(is_page()){ echo get_the_title(); } elseif(is_home()) { echo "Trang Đăng ký 3G, 4G nhà mạng Vinaphone"; } ?></title>
<meta charset="UTF-8">
...
<script type="text/javascript" src='<?php echo get_template_directory_uri(); ?>/assets/js/jquery_3_3_1.min.js integrity=""'></script>
...
<style type="text/css">
    ...
    <?php echo (is_home())? ".xanhduong {background: #00a1e5; }":"" ?>
    .muahang-btn{
...
<div class="wrap">
        ...
        <div class="container text-right">
            ...
            <div class="carrers-icon pull-left">
                ...
                <a id="hover-viettel" class="icon" href="<?php echo home_url(); ?>/viettel"> 
                    <img src="<?php echo get_template_directory_uri(); ?>/images/viettel.png">
                </a>
            </div>
    ...
    <div class="navigate" id="navigate">
        ...
        <div class="container">
            <a href="<?php echo home_url(); ?>" class="logo hidden-xs"> <img src="<?php echo get_template_directory_uri();?>/assets/images/logo-white.png"/> </a>
            <ul class="menu-nav">
                <?php wp_nav_menu( array( 'theme_location' =>
                 'main-menu','menu_class' => 'menu') ); ?>
            </ul>
        </div>
    </div>
    </section>