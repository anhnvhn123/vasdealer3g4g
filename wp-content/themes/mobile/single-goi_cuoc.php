...
h3{
    ...
    color: #fff !important;
    margin-bottom: 0px;
    background-color: <?php if($provider == 'viettel') echo '#00918c'; else echo '#0060b0'; ?>;
}
</style>
<?php get_header($provider); ?>
    ...
    <section id="body" class="body">
        ...
        <div class="container">
            <div id="1" class="entry-content" style="padding: 20px 10px;">
            ...
            <div id="2" class="entry-content col-xs-12">
                <?php the_content(); ?>
