...
if (!empty($goi1) && is_array($goi1)) { // Check not empty
...
if (!empty($goi3) && is_array($goi3)) { // Check not empty
...
if (!empty($goi4) && is_array($goi4)) { // Check not empty
...
if (!empty($goi2) && is_array($goi2)) { // Check not empty
...
<section id="body" class="body">
    ...
    <div class="container">
        ...
        <div class="reg-box">
            <div class="container" style="width: 100%">
                <?php $goi_cuoc_home = get_field('goi-cuoc', 3361); ?>
    ...
    background: #d8d6d6;">GÓI CƯỚC 3G VINAPHONE</h2>
            ...
            <?php $goi_cuoc_3g = get_field('goi-cuoc', 3354); ?>
                    ...
                    <div style="border: 2px solid #00a1e5;">
                        ...
                        <div class="table-responsive">
                            <table style="width: 100%;"
                                   class="table table-striped table-bordered table-condensed noborder">
                                <tbody>
                                <tr>
                                    <td class="noborder">
                                        <b>Dung lượng :</b>
                                ...
                                <tr>
                                    <td class="noborder">
                                        <b>Giá cước :</b>
                                        <?php echo product_price(get_field('gia_cuoc', $value['goi-cuoc'])); ?>
                                        đ/<?php echo get_field('chu_ky', $value['goi-cuoc']); ?>
    ...
    background: #d8d6d6;">GÓI CƯỚC 4G VINAPHONE</h2>
            ...
            <?php $goi_cuoc_3g = get_field('goi-cuoc', 3355); ?>
            <?php foreach ($goi_cuoc_3g as $key => $value) : ?>
                <div class="col-md-3 col-sm-6 category-list" style="margin-bottom: 1%;">
                    <div style="border: 2px solid #00a1e5;">
                        <p align="center" style="border:5px double #00a1e5;background-color: #00a1e5;color: #FFFFFF"><b>
        ...
        <div class="row">
            <div class="col-md-6">
                <ul class="nav nav-pills" style="border-bottom: 2px solid #337ab7; ">
                    <li class="active"><a href="<?php echo get_category_link(4) ?>" data-toggle="tab"
                                          aria-expanded="true"
                                          style="border-bottom-left-radius: 0px; border-bottom-right-radius: 0px;"><b>TIN
                                TỨC</b></a>
                    </li>
                </ul>
                <?php $args = array(
                    ...
                    <div class="media news_item" style="margin-bottom: 10px;">
                        <div class="" style="float: left; margin-right: 10px;">
                            <a href="<?php echo the_permalink(); ?>">
                                <img src="<?php echo the_post_thumbnail_url('index-thumb'); ?>"
                                     class="media-object wp-post-image" alt="<?php echo the_title(); ?>"
                                     style="object-fit: cover; vertical-align: middle;" width="100" height="60">
                            </a>
                        </div>
                        <div class="media-body" style="vertical-align: middle;">
                            <a href="<?php echo the_permalink(); ?>">
                                <h4 class="media-heading"
                                    style="color: #444; font-size: 16px; vertical-align: middle; line-height: 24px;">
            ...
            <div class="col-md-6">
                <ul class="nav nav-pills" style="border-bottom: 2px solid #337ab7; ">
                    <li class="active"><a href="<?php echo get_category_link(7) ?>" data-toggle="tab"
                                          aria-expanded="true"
                                          style="border-bottom-left-radius: 0px; border-bottom-right-radius: 0px;"><b>KHUYẾN
                                MÃI</b></a>
                    </li>
                </ul>
                <?php $args = array(
